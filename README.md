...
1. Lakukan cloning project.
    ```sh
    git clone https://github.com/vigorjs/United-Tractors-Test.git
    ```
2. Spesifikasi project ini membutuhkan **php** versi **^8**, **composer** versi **^2** dan **Laravel** versi **9**.
...
10. run.
    ...
    php artisan serve
    ```
11. Akses Dokumentasi API via Swagger UI atau (Import file postman.json di postman)
    ```sh
